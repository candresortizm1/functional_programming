# Exercises to practice the Functional Programming

## Java + Spring + REST Academy - January 2022

According to the practice to the Topic 3: Functional Programming the exercises are from this repository.
